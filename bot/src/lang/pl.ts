...
export const recordingFinished = (name: string) => `Nagrałem ${formatMeetingName(name)} pomyślnie`

export const ENTER_MEETING_YOURSELF = `Dołącz do spotkania`

export const MAY_NEED_YOUR_HELP_WITH_CAPTCHA = 'Mogę potrzebować Twojej pomocy z Captcha'
...
export const COMMAND_UPCOMING_DESCRIPTION = 'Zobacz jakie spotkania będę wkrótce nagrywał'
